...
import { UpdatePermitsController } from "./updatePermitsController";
...
const permitsUpdater = new PermitsUpdater(userRepository)
...
export const updatePermitsController = new UpdatePermitsController(permitsUpdater);
